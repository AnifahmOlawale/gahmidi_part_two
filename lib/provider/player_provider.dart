...
class PlayerProvider extends ChangeNotifier {
  ...
  Future playCurrent() async {
    ...
    MediaItem updatedItem = MediaItem(
      ...
      album: appName,
      artUri: Uri.parse(
          "https://play-lh.googleusercontent.com/xpKaZr55WIMFH2IbuvdZL-LDXsrZmmrZOx-6w9KOszlOtDkIt8oo4eDT35Kr8C37PLQ=s512-rw"),
    );
...
//NEXT
  void next() {
    int nextIndex =
        _currentPlayerIndex == 76 ? 18 : _currentPlayerIndex! + 1; //TODO
...
//PREVIOUSE
  void previous() {
    int previousIndex =
        _currentPlayerIndex == 18 ? 76 : _currentPlayerIndex! - 1; //TODO
...
//SHUFFLE
  void shuffle() {
    int randomIndex = 19 +
        random.nextInt(77 -
            19 +
            1); //TODO max=77 min =19--------- min + random.nextInt(max - min + 1);    String arabicSurahName = quranCsv.listOfSurahs.elementAt(randomIndex)[2];
