...
class ThemeColor extends ChangeNotifier {
  ...
  final Color _primaryColour =
      Color.fromRGBO(60, 60, 114, 1); //Color.fromRGBO(0, 128, 129, 1);
  final Color _secondaryColour = Color.fromRGBO(74, 74, 134, 1);
  final Color _backgroundColour = Color.fromRGBO(60, 60, 114, 1);
  final Color _cardColour = Color.fromRGBO(74, 74, 134, 1);
  final Color _playerCardColour = Color.fromARGB(201, 74, 74, 129);
  ...
  final Color _quranTransColour = Color.fromRGBO(60, 60, 114, 1);
  final Color _textColour = Colors.white;
  final Color _controlColour = Color.fromRGBO(60, 60, 114, 1);
  ...
  final Color _quranTransDark = Colors.white;
  final Color _textDark = Colors.white;
  final Color _controlDark = Colors.white;

  //Light Theme
  final Color _primaryLight = Color.fromRGBO(60, 60, 114, 1);
  final Color _secondaryLight = Color.fromRGBO(74, 74, 134, 1);
  //final Color _backgroundLight = Color.fromRGBO(60, 60, 114, 1);
  final Color _cardLight = Color.fromRGBO(74, 74, 134, 1);
  final Color _playerCardLight = Color.fromARGB(201, 74, 74, 129);
  ...
  final Color _quranTransLight = Color.fromRGBO(60, 60, 114, 1);
  final Color _textLight = Color.fromRGBO(60, 60, 114, 1);
  final Color _controlLight = Color.fromRGBO(60, 60, 114, 1);
  ...
  ThemeData _theme = ThemeData(
    ...
    colorScheme: ColorScheme.fromSeed(
      seedColor: Color.fromRGBO(60, 60, 114, 1),
      primary: Color.fromRGBO(60, 60, 114, 1),
      secondary: Color.fromRGBO(74, 74, 134, 1),
      brightness: Brightness.dark,
    ),
  ...
  final Color _themeDesign = Color.fromRGBO(60, 60, 114, 1);
  final Color _selectedCardColour = Color.fromRGBO(220, 170, 221, 1);
  final Color _selectedTextColour = Color.fromRGBO(60, 60, 114, 1);
